...
public class FloorController extends BaseController {
    ...
    public ResponseResult deleteFloor(@PathVariable("id") Long id) {
    ...
    public ResponseResult<FloorVo> getFloor(@PathVariable("id") Long id) {
    ...
    @ApiOperation(value = "按床位状态获取楼层房间床位", notes = "根据床位状态获取楼层信息列表")
