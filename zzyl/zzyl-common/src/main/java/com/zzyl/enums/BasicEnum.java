...
public enum BasicEnum implements IBasicEnum {
    ...
    Data_State_Exception(1420,"账号被禁用"),
    Password_Error(1421,"密码错误"),
    ...
    PHONE_CANNOT_NULL(1533,"联系方式不能为空"),
    RESERVATION_TYPE_CANNOT_NULL(1534,"预约类型不能为空"),
    RESERVATION_TIME_CANNOT_NULL(1535,"预约时间不能为空"),
    NAME_CANNOT_NULL(1536,"访客姓名不能为空"),
    TYPE_1(1537,"探访预约必须填写被访老人"),
    REPEAT(1538,"该时间段已存在预约，请勿重复预约"),
    ELDER_ALREADY_RETREATED(1539, "该老人已退住"),
    ELDER_RETREATING(1540, "该老人正在退住中");
