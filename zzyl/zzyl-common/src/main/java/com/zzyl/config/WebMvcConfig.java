...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        //后台拦截
        List<String> ignoreUrls = new ArrayList<>(securityConfigProperties.getIgnoreUrls());
        ignoreUrls.addAll(Arrays.asList(EXCLUDE_PATH_PATTERNS));
        registry.addInterceptor(userTokenInterceptor).excludePathPatterns(ignoreUrls).excludePathPatterns("/customer/**").addPathPatterns("/**");
    }
